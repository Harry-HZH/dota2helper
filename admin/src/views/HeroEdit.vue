      ...
      <el-tabs value="basic" type="border-card">
        <el-tab-pane label="基础信息" name="basic">
          ...
          <el-form-item label="力量">
            <el-input v-model="model.scores.strength"></el-input>
          </el-form-item>
          <el-form-item label="敏捷">
            <el-input v-model="model.scores.agility"></el-input>
          </el-form-item>
          <el-form-item label="智力">
            <el-input v-model="model.scores.intelligence"></el-input>
          </el-form-item>
          ...
          <el-row type="flex" style="flex-wrap: wrap">
            <el-col :md="12" v-for="(item, i) in model.skills" :key="i">
              ...
              <el-form-item label="伤害">
                <el-input v-model="item.damage"></el-input>
              </el-form-item>
